...
class CrmServices(models.Model):
    ...
    categoryid = models.IntegerField(db_column='categoryID')  # Field name made lowercase.
    templateid = models.ForeignKey('PriceTemplates', models.DO_NOTHING, db_column='templateID')  # Field name made lowercase.
...
class LogsClients(models.Model):
    logclientid = models.AutoField(db_column='logClientID', primary_key=True)  # Field name made lowercase.
    clientid = models.IntegerField(db_column='clientID')  # Field name made lowercase.
    userid = models.IntegerField(db_column='userID')  # Field name made lowercase.
    message = models.TextField(blank=True, null=True)
    olddata = models.JSONField(db_column='oldData', blank=True, null=True)  # Field name made lowercase.
