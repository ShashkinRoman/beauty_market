...
def dashboard(request):
    ...
    date_period = count_currently_and_previous_date(date.today(), 'month')
    revenue_brand = revenue_by_brands(date_period.get('currently_start'), date_period.get('currently_end'))
    html = "<html><body>%s<br><body></html>" % revenue, clients, revenue_brand
